...
const SpeachBubbleCard = ({ children, rating }: Props) => {
  return (
    <div>
      <div className="relative  w-[600px] rounded-2xl border border-gray-100 bg-white shadow-[0px_4px_50px_0px_#00000025]">
        ...
        <div className="p-8 pb-16">
          <div className="border-l-2 border-gray-200 pl-8 ml-20">
            {children}
          </div>
        </div>
