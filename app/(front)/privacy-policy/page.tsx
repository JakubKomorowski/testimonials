      ...
      <article className="container md:px-16">
        ...
        <ul className="py-4">
          ...
          <li className="list-disc ml-10 py-1">
            ...
            it refers to Jakub Komorowski SEO Projekt, Mariacka 4/1, Gdynia,
            Polska that is responsible for your information under this Privacy
            Policy.
          </li>
          <li className="list-disc ml-10 py-1">
          ...
          <li className="list-disc ml-10 py-1">
            Personnel: refers to those individuals who are employed by Testi
            crafter or are under contract to perform a service on behalf of one
            of the parties.
          </li>
          <li className="list-disc ml-10 py-1">
        ...
        <ul className="py-4">
          ...
          <li className="list-disc ml-10 py-1">Password</li>
        </ul>
        ...
        <ul className="py-4">
          <li className="list-disc ml-10 py-1">
            ...
            upload any picture straight from the website, you can safely deny
        ...
        <ul className="py-4">
          ...
          <li className="list-disc ml-10 py-1">To process transactions</li>
          <li className="list-disc ml-10 py-1">
        ...
        auditing, research and reporting for us and our advertisers. We may also
        ...
        your information, (2) change your preferences with respect to
        communications and other information you receive from us, or (3) receive
        a record of the information we have relating to you. Such updates,
        corrections, changes and deletions will have no effect on other
        information that we maintain, or information that we have provided to
        third parties in accordance with this Privacy Policy prior to such
        ...
        under Privacy Shield, or the Swiss-US framework. The laws of Polska,
        ...
        other local, state, national, or international laws. By using Testi
        crafter or contacting us directly, you signify your acceptance of this
        ...
        and the offerings made by the third parties. Advertising keeps Testi
        crafter and many of the websites and services you use free of charge. We
        ...
        retrieve and remove personal data. We got you! We've been set up as self
