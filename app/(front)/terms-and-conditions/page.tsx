  ...
  return (
    <main>
      ...
      <article className="container md:px-16">
        ...
        <p className="py-2">
          {" "}
          By accessing and placing an order with Testi crafter, you confirm that
          ...
          you and Testi crafter.
        </p>
        <p className="py-2">
          Under no circumstances shall Testi crafter team be liable for any
          ...
          Testi crafter team or an authorized representative has been advised of
        ...
        <p className="pt-2">
          Testi crafter will not be responsible for any outcome that may occur
        ...
        Testi crafter grants you a revocable, non-exclusive, non-transferable,
        ...
        Conditions are a contract between you and Testi crafter (referred to in
        these Terms &amp; Conditions as "Testi crafter", "us", "we" or "our"),
        the provider of the Testi crafter website and the services accessible
        from the Testi crafter website (which are collectively referred to in
        these Terms &amp; Conditions as the "Testi crafter Service"). You are
        ...
        <ul className="py-4">
          ...
          <li className="list-disc ml-10 py-1">
            ...
            notice of copyright or trademark) of Testi crafter or its
            affiliates, partners, suppliers or the licensors of the website.
          </li>
        </ul>
        <h2 className="pb-4 pt-6">Return and Refund Policy</h2>
        Thanks for shopping at Testi crafter. We appreciate the fact that you
        ...
        conditions that apply to transactions at Testi crafter. We’ll be as
        brief as our attorneys will allow. The main thing to remember is that by
        placing an order or making a purchase at Testi crafter, you agree to the
        terms along with Testi crafter's Privacy Policy. If, for any reason, You
        ...
        (collectively, "Suggestions") provided by you to Testi crafter with
        respect to the website shall remain the sole and exclusive property of
        Testi crafter. Testi crafter shall be free to use, copy, modify,
        ...
        You acknowledge and agree that Testi crafter may stop (permanently or
        ...
        specifically inform Testi crafter when you stop using the Service. You
        acknowledge and agree that if Testi crafter disables access to your
        ...
        Testi crafter reserves the right to modify, suspend or discontinue,
        ...
        Testi crafter may from time to time provide enhancements or improvements
        ...
        functionalities of the website. You agree that Testi crafter has no
        ...
        crafter. Testi crafter may, in its sole discretion, at any time and for
        ...
        notice from Testi crafter, in the event that you fail to comply with any
        ...
        this Agreement will not limit any of Testi crafter's rights or remedies
        ...
        You agree to indemnify and hold Testi crafter and its parents,
        ...
        permitted under applicable law, Testi crafter, on its own behalf and on
        ...
        Without limitation to the foregoing, Testi crafter provides no warranty
        ...
        limiting the foregoing, neither Testi crafter nor any Testi crafter's
        ...
        content, or e-mails sent from or on behalf of Testi crafter are free of
        ...
        of Testi crafter and any of its suppliers under any provision of this
        ...
        this Agreement), even if Testi crafter or any supplier has been advised
        ...
        other legal notices published by Testi crafter on the Services, shall
        constitute the entire agreement between you and Testi crafter concerning
        ...
        term or any other term, and Testi crafter's failure to assert any right
        or provision under this Agreement shall not constitute a waiver of such
        right or provision. YOU AND Testi crafter AGREE THAT ANY CAUSE OF ACTION
        ...
        Testi crafter reserves the right, at its sole discretion, to modify or
        ...
        apply when you use or purchase other Testi crafter's services, which
        Testi crafter will provide to you at the time of such use or purchase.
        ...
        thereof), are owned by Testi crafter, its licensors or other providers
        ...
        without the express prior written permission of Testi crafter, unless
        ...
        ENFORCEMENT OR VALIDITY OF YOUR OR Testi crafter's INTELLECTUAL PROPERTY
        RIGHTS. The term “dispute” means any dispute, action, or other
        controversy between you and Testi crafter concerning the Services or
        ...
        In the event of a dispute, you or Testi crafter must give the other a
        ...
        . Testi crafter will send any Notice of Dispute to you by mail to your
        ...
        After sixty (60) days, you or Testi crafter may commence arbitration.
        <h2 className="pb-4 pt-6">Binding Arbitration</h2>
        If you and Testi crafter don’t resolve any dispute by informal
        ...
        and will become the sole property of Testi crafter without any
        compensation or credit to you whatsoever. Testi crafter and its
        ...
        Testi crafter may, from time to time, include contests, promotions,
        ...
        representative of Testi crafter. Testi crafter will be entitled to
        ...
        you. Testi crafter operates and controls the Testi crafter Service from
        ...
        those persons who choose to access the Testi crafter Service from other
        locations do so on their own initiative and are solely responsible for
        compliance with local laws, if and to the extent local laws are
        applicable. These Terms &amp; Conditions (which include and incorporate
        the Testi crafter Privacy Policy) contains the entire understanding, and
        supersedes all prior understandings, between you and Testi crafter
        ...
        Testi crafter is not responsible for any content, code or any other
        imprecision. Testi crafter does not provide warranties or guarantees. In
        no event shall Testi crafter be liable for any special, direct,
        ...
        any time without prior notice. The Testi crafter Service and its
        contents are provided "as is" and "as available" without any warranty or
        representations of any kind, whether express or implied. Testi crafter
        is a distributor and not a publisher of the content supplied by third
        parties; as such, Testi crafter exercises no editorial control over such
        ...
        merchandise provided through or accessible via the Testi crafter
        Service. Without limiting the foregoing, Testi crafter specifically
        disclaims all warranties and representations in any content transmitted
        on or in connection with the Testi crafter Service or on sites that may
        appear as links on the Testi crafter Service, or in the products
        ...
        foregoing, Testi crafter does not warrant that the Testi crafter Service
