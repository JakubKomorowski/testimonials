    ...
    <main>
      <header className="bg-bg py-12 md:py-16 flex items-center justify-center mb-16">
        <div className="max-w-[1100px] flex-1 mx-4 md:mx-16">
          ...
          <h1 className="text-white leading-[1.15]">Terms & Conditions</h1>
        </div>
      </header>
      <article className="container md:px-16">
        <p className="py-2">Updated at 2023-12-23 </p>
        <h2 className="pb-4 pt-6">General Terms</h2>
        <p className="py-2">
          {" "}
          By accessing and placing an order with Trust catcher, you confirm that
          ...
          you and Trust catcher.
        </p>
        <p className="py-2">
          Under no circumstances shall Trust catcher team be liable for any
          ...
          Trust catcher team or an authorized representative has been advised of
        ...
        <p className="pt-2">
          Trust catcher will not be responsible for any outcome that may occur
        ...
        .<h2 className="pb-4 pt-6">License</h2>
        Trust catcher grants you a revocable, non-exclusive, non-transferable,
        ...
        Conditions are a contract between you and Trust catcher (referred to in
        these Terms &amp; Conditions as "Trust catcher", "us", "we" or "our"),
        the provider of the Trust catcher website and the services accessible
        from the Trust catcher website (which are collectively referred to in
        these Terms &amp; Conditions as the "Trust catcher Service"). You are
        agreeing to be bound by these Terms &amp; Conditions. If you do not
        agree to these Terms &amp; Conditions, please do not use the Testi
        crafter Service. In these Terms &amp; Conditions, "you" refers both to
        ...
        <h2 className="pb-4 pt-6">Definitions and key terms</h2>
        ...
        <ul className="py-4">
          ...
          <li className="list-disc ml-10 py-1">
            ...
            it refers to Jakub Komorowski SEO Projekt, Mariacka 4/1, 81-383,
            Gdynia that is responsible for your information under this Terms
            &amp; Conditions.
          </li>
          <li className="list-disc ml-10 py-1">
        ...
        <h2 className="pb-4 pt-6">Restrictions</h2>
        ...
        <ul className="py-4">
          ...
          <li className="list-disc ml-10 py-1">
            ...
            notice of copyright or trademark) of Trust catcher or its
            affiliates, partners, suppliers or the licensors of the website.
          </li>
        </ul>
        <h2 className="pb-4 pt-6">Return and Refund Policy</h2>
        Thanks for shopping at Trust catcher. We appreciate the fact that you
        ...
        conditions that apply to transactions at Trust catcher. We’ll be as
        brief as our attorneys will allow. The main thing to remember is that by
        placing an order or making a purchase at Trust catcher, you agree to the
        terms along with Trust catcher's Privacy Policy. If, for any reason, You
        are not completely satisfied with any good or service that we provide,
        don't hesitate to contact us and we will discuss any of the issues you
        are going through with our product.
        <h2 className="pb-4 pt-6">Your Suggestions</h2>
        Any feedback, comments, ideas, improvements or suggestions
        (collectively, "Suggestions") provided by you to Trust catcher with
        respect to the website shall remain the sole and exclusive property of
        Trust catcher. Trust catcher shall be free to use, copy, modify,
        publish, or redistribute the Suggestions for any purpose and in any way
        without any credit or any compensation to you.
        <h2 className="pb-4 pt-6">Your Consent</h2>
        ...
        <h2 className="pb-4 pt-6">Links to Other Websites</h2>
        This Terms &amp; Conditions applies only to the Services. The Services
        may contain links to other websites not operated or controlled by Testi
        ...
        <h2 className="pb-4 pt-6">Cookies</h2>
        ...
        <h2 className="pb-4 pt-6">Changes To Our Terms &amp; Conditions</h2>
        You acknowledge and agree that Trust catcher may stop (permanently or
        ...
        specifically inform Trust catcher when you stop using the Service. You
        acknowledge and agree that if Trust catcher disables access to your
        ...
        <h2 className="pb-4 pt-6">Modifications to Our website</h2>
        Trust catcher reserves the right to modify, suspend or discontinue,
        ...
        <h2 className="pb-4 pt-6">Updates to Our website</h2>
        Trust catcher may from time to time provide enhancements or improvements
        ...
        functionalities of the website. You agree that Trust catcher has no
        obligation to (i) provide any Updates, or (ii) continue to provide or
        enable any particular features and/or functionalities of the website to
        ...
        <h2 className="pb-4 pt-6">Third-Party Services</h2>
        ...
        <h2 className="pb-4 pt-6">Term and Termination</h2>
        This Agreement shall remain in effect until terminated by you or Testi
        crafter. Trust catcher may, in its sole discretion, at any time and for
        ...
        notice from Trust catcher, in the event that you fail to comply with any
        ...
        and delete all copies of the website from your computer. Termination of
        this Agreement will not limit any of Trust catcher's rights or remedies
        ...
        <h2 className="pb-4 pt-6">Copyright Infringement Notice</h2>
        ...
        <h2 className="pb-4 pt-6">Indemnification</h2>
        You agree to indemnify and hold Trust catcher and its parents,
        ...
        <h2 className="pb-4 pt-6">No Warranties</h2>
        The website is provided to you "AS IS" and "AS AVAILABLE" and with all
        faults and defects without warranty of any kind. To the maximum extent
        permitted under applicable law, Trust catcher, on its own behalf and on
        ...
        Without limitation to the foregoing, Trust catcher provides no warranty
        ...
        limiting the foregoing, neither Trust catcher nor any Trust catcher's
        ...
        content, or e-mails sent from or on behalf of Trust catcher are free of
        ...
        <h2 className="pb-4 pt-6">Limitation of Liability</h2>
        Notwithstanding any damages that you might incur, the entire liability
        of Trust catcher and any of its suppliers under any provision of this
        ...
        maximum extent permitted by applicable law, in no event shall Testi
        crafter or its suppliers be liable for any special, incidental,
        ...
        this Agreement), even if Trust catcher or any supplier has been advised
        ...
        <h2 className="pb-4 pt-6">Severability</h2>
        If any provision of this Agreement is held to be unenforceable or
        invalid, such provision will be changed and interpreted to accomplish
        the objectives of such provision to the greatest extent possible under
        applicable law and the remaining provisions will continue in full force
        and effect. This Agreement, together with the Privacy Policy and any
        other legal notices published by Trust catcher on the Services, shall
        constitute the entire agreement between you and Trust catcher concerning
        the Services. If any provision of this Agreement is deemed invalid by a
        ...
        term or any other term, and Trust catcher's failure to assert any right
        or provision under this Agreement shall not constitute a waiver of such
        right or provision. YOU AND Trust catcher AGREE THAT ANY CAUSE OF ACTION
        ...
        <h2 className="pb-4 pt-6">Waiver</h2>
        ...
        waiver of any subsequent breach. o failure to exercise, and no delay in
        exercising, on the part of either party, any right or any power under
        this Agreement shall operate as a waiver of that right or power. Nor
        shall any single or partial exercise of any right or power under this
        ...
        govern.
        <h2 className="pb-4 pt-6">Amendments to this Agreement</h2>
        Trust catcher reserves the right, at its sole discretion, to modify or
        ...
        use Trust catcher.
        <h2 className="pb-4 pt-6">Entire Agreement</h2>
        The Agreement constitutes the entire agreement between you and Testi
        crafter regarding your use of the website and supersedes all prior and
        contemporaneous written or oral agreements between you and Testi
        crafter. You may be subject to additional terms and conditions that
        apply when you use or purchase other Trust catcher's services, which
        Trust catcher will provide to you at the time of such use or purchase.
        <h2 className="pb-4 pt-6">Updates to Our Terms</h2>
        ...
        your account.
        <h2 className="pb-4 pt-6">Intellectual Property</h2>
        ...
        thereof), are owned by Trust catcher, its licensors or other providers
        ...
        without the express prior written permission of Trust catcher, unless
        and except as is expressly provided in these Terms &amp; Conditions. Any
        unauthorized use of the material is prohibited.
        <h2 className="pb-4 pt-6">Agreement to Arbitrate</h2>
        ...
        ENFORCEMENT OR VALIDITY OF YOUR OR Trust catcher's INTELLECTUAL PROPERTY
        RIGHTS. The term “dispute” means any dispute, action, or other
        controversy between you and Trust catcher concerning the Services or
        ...
        <h2 className="pb-4 pt-6">Notice of Dispute</h2>
        In the event of a dispute, you or Trust catcher must give the other a
        ...
        <Link
          ...
          data-cfemail="cfbbaabcbba6acbdaea9bbaabd8fa8a2aea6a3e1aca0a2"
        >
          [email protected]
        </Link>
        . Trust catcher will send any Notice of Dispute to you by mail to your
        address if we have it, or otherwise to your email address. You and Testi
        crafter will attempt to resolve any dispute through informal negotiation
        within sixty (60) days from the date the Notice of Dispute is sent.
        After sixty (60) days, you or Trust catcher may commence arbitration.
        <h2 className="pb-4 pt-6">Binding Arbitration</h2>
        If you and Trust catcher don’t resolve any dispute by informal
        ...
        <h2 className="pb-4 pt-6">Submissions and Privacy</h2>
        ...
        and will become the sole property of Trust catcher without any
        compensation or credit to you whatsoever. Trust catcher and its
        ...
        such ideas.
        <h2 className="pb-4 pt-6">Promotions</h2>
        Trust catcher may, from time to time, include contests, promotions,
        ...
        <h2 className="pb-4 pt-6">Typographical Errors</h2>
        ...
        <h2 className="pb-4 pt-6">Miscellaneous</h2>
        ...
        representative of Trust catcher. Trust catcher will be entitled to
        ...
        you. Trust catcher operates and controls the Trust catcher Service from
        ...
        those persons who choose to access the Trust catcher Service from other
        locations do so on their own initiative and are solely responsible for
        compliance with local laws, if and to the extent local laws are
        applicable. These Terms &amp; Conditions (which include and incorporate
        the Trust catcher Privacy Policy) contains the entire understanding, and
        supersedes all prior understandings, between you and Trust catcher
        ...
        <h2 className="pb-4 pt-6">Disclaimer</h2>
        Trust catcher is not responsible for any content, code or any other
        imprecision. Trust catcher does not provide warranties or guarantees. In
        no event shall Trust catcher be liable for any special, direct,
        ...
        any time without prior notice. The Trust catcher Service and its
        contents are provided "as is" and "as available" without any warranty or
        representations of any kind, whether express or implied. Trust catcher
        is a distributor and not a publisher of the content supplied by third
        parties; as such, Trust catcher exercises no editorial control over such
        ...
        merchandise provided through or accessible via the Trust catcher
        Service. Without limiting the foregoing, Trust catcher specifically
        disclaims all warranties and representations in any content transmitted
        on or in connection with the Trust catcher Service or on sites that may
        appear as links on the Trust catcher Service, or in the products
        provided as a part of, or otherwise in connection with, the Testi
        crafter Service, including without limitation any warranties of
        merchantability, fitness for a particular purpose or non-infringement of
        third party rights. No oral advice or written information given by Testi
        crafter or any of its affiliates, employees, officers, directors,
        ...
        foregoing, Trust catcher does not warrant that the Trust catcher Service
        will be uninterrupted, uncorrupted, timely, or error-free.
        <h2 className="pb-4 pt-6">Contact Us</h2>
        ...
        <ul className="py-4">
          <li className="list-disc ml-10 py-1">
            ...
            <Link
              className="__cf_email__"
              href="/cdn-cgi/l/email-protection"
              data-cfemail="186c7d6b6c717b6a797e6c7d6a587f75797174367b7775"
            >
              [email protected]
            </Link>
          </li>
